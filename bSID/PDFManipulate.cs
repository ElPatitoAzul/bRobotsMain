...
namespace BackRobotTDM.bSID
{
    public class PDFManipulate
    {
        ...
        public void PrefsManagement(string src, Enumerations.Actas.Preferences prefType, string estado)
        {
                tools._PATHER_("tmp");
                var pdfDocument = new PdfDocument(new PdfReader(src));
                ...
                if (text.Contains("Acta de Nacimiento"))
                {
                    ...
                    if (prefType == Enumerations.Actas.Preferences.Foliado)
                    {
                    ...
                    else if (prefType == Enumerations.Actas.Preferences.Reversado)
                    {
                        string qrCodeText = $"CURP:{curp}\nIdentificador Electrónico: {id}";
                        QrGenerator(qrCodeText, curp, state);
                        pdfDocument.Close();
